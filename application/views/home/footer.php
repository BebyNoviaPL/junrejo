		...
		<div class="row">
			...
			<div class="col-lg-2  col-md-6 footv3-left mt-md-0 mt-5">
				...
				<ul class="list-agileits">
					...
					<li class="my-2">
						<a href="<?php echo base_url("assets/") ?>about.html">
							About Us
						</a>
					</li>
					<li class="my-2">
						<a href="<?php echo base_url("assets/") ?>projects.html">
							Projects
						</a>
					</li>
					<li class="mb-2">
						<a href="<?php echo base_url("assets/") ?>features.html">
							Features
						</a>
					</li>
					<li>
...
<div class="cpy-right text-center">
	<p>© 2019 Pemerintahan Desa Beji Kota Batu | Design by
