...
<head>
    ...
    <link href="<?php echo base_url("assets_admin/") ?>vendor/select2/select2.min.css" rel="stylesheet" media="all">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="index.php">
                                <img src="<?php echo base_url("assets_admin/") ?>images/icon/logo.png" alt="Login Admin">
                            </a>
                        </div>
