        ...
        <div class="card">
          ...
          <div class="card-body card-block">
            ...
            <div class="form-group">
              ...
              <input type="text" id="input-jenis_layanan" name="jenis_layanan" placeholder="Masukan jenis_layanan" class="form-control" value="<?php echo $ppid_layanan->jenis_layanan ?>">
              <?php echo form_error("jenis_layanan") ?>
            </div>
            
             <div class="form-group">
              <label for="input-dokumen" class="form-control-label">dokumen</label>
              <input type="text" id="input-dokumen" name="dokumen" placeholder="Masukan dokumen" class="form-control" value="<?php echo $ppid_layanan->dokumen ?>">
              <?php echo form_error("dokumen") ?>
            </div>
             <div class="form-group">
              <label for="input-syarat" class="form-control-label">syarat</label>
              <input type="text" id="input-syarat" name="syarat" placeholder="Masukan syarat" class="form-control" value="<?php echo $ppid_layanan->syarat ?>">
              <?php echo form_error("syarat") ?>
            </div>

              <div class="form-group">
              <label for="input-biaya" class="form-control-label">biaya</label>
              <input type="text" id="input-biaya" name="biaya" placeholder="Masukan biaya" class="form-control" value="<?php echo $ppid_layanan->biaya ?>">
              <?php echo form_error("biaya") ?>
            </div>
             <div class="form-group">
              <label for="input-proses" class="form-control-label">proses</label>
              <input type="text" id="input-proses" name="proses" placeholder="Masukan proses" class="form-control" value="<?php echo $ppid_layanan->proses ?>">
