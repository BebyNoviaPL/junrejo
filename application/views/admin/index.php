                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="<?php echo base_url("assets_admin/") ?>index.html">Dashboard 1</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url("assets_admin/") ?>index2.html">Dashboard 2</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url("assets_admin/") ?>index3.html">Dashboard 3</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url("assets_admin/") ?>index4.html">Dashboard 4</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="<?php echo base_url("assets_admin/") ?>chart.html">
                        ...
                        <li>
                            <a href="<?php echo base_url("assets_admin/") ?>map.html">
                                <i class="fas fa-map-marker-alt"></i>Berita</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="<?php echo base_url("assets_admin/") ?>login.html">Login</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url("assets_admin/") ?>register.html">Register</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url("assets_admin/") ?>forget-pass.html">Forget Password</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-copy"></i>Tentang Desa</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="login.html">Profil Desa</a>
                                </li>
                                <li>
                                    <a href="register.html">Struktur Desa</a>
                                </li>
                        ...
                        <li>
                         ...
                         <li>
                            <a href="map.html">
                                <i class="fas fa-map-marker-alt"></i>Comment</a>
                        </li>
                                                ...
                                                <div class="recei-mess-wrap">
                                                    ...
                                                    <div class="recei-mess__inner">
                                                        <div class="avatar avatar--tiny">
                                                            <img src="<?php echo base_url("assets_admin/") ?>images/icon/avatar-02.jpg" alt="John Smith">
                                                        </div>
