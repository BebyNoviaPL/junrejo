        ...
        <div class="card">
          ...
          <div class="card-body card-block">
            ...
            <div class="form-group">
              ...
              <input type="text" id="input-visi" name="visi" placeholder="Masukan visi" class="form-control" value="<?php echo set_value("visi") ?>">
              <?php echo form_error("visi") ?>
            </div>
            
            <div class="form-group">
            <label for="input-misi" class="form-control-label">misi</label>
              <input type="text" id="input-misi" name="misi" placeholder="Masukan misi" class="form-control" value="<?php echo set_value("misi") ?>">
              <?php echo form_error("misi") ?>
             </div>
              <div class="form-group">
            <label for="input-tugas" class="form-control-label">tugas</label>
              <input type="text" id="input-tugas" name="tugas" placeholder="Masukan tugas" class="form-control" value="<?php echo set_value("tugas") ?>">
